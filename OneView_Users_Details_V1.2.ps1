<#
.SYNOPSIS
This script performs various tasks related to HPE OneView.

.DESCRIPTION
This script clears the console window, imports required modules, imports an appliances list from a CSV file, and checks for the existence of a credential folder. 
It also logs the execution of each task.
...
.EXAMPLE
.\OneView_Users_Details_V1.2.ps1

This example runs the script and performs the tasks described above.

.NOTES
Author: Sabri CHARCHOUF
Version: 1.2
Date: 06/03/2024
#>
